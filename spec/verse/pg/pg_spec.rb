  ...
  %i<simple cluster>.each do |mode|
    context "mode #{mode}" do
      ...
      context "testing repository" do
        ...
        let(:employee_repo){ Spec::Pg::EmployeeRepository.new(Verse::Auth::Context[:system]) }
        ...
        context "#index_impl with query_count" do
          ...
          it "handles pagination correctly with query_count" do
            ...
            expect(metadata[:count]).to eq(1300) # offset (300) + limited_count (1000)
